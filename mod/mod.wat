...
(func $start
  ...
  (global.set $tick-len
    (i32.div_u (i32.mul (global.get $sample-rate) (i32.const 5)) (i32.const 250)))
    ...
    (then
      ...
      (loop $channel
        ...
        block $1e
          ...
          (br_if $X (i32.gt_s (local.get $param) (i32.const 0)))
          ...
          (br_if $X (i32.le_s (local.get $param) (i32.const 0)))

...
(data (i32.const 1100)
  ...
  (i8  3    0) (i16   4) (i8 0  0  0) (f32 0)     ;; 13 dead
  ;; end=1243
)
        ...
        (i32.add
          (i32.trunc_f32_s
            (f32.mul
              (call $random)
              (f32.convert_i32_s
                (i32.load8_u offset=1244 (local.get $rand_info)))))
          (i32.load8_u offset=1243 (local.get $rand_info))))
      ...
      (local.set $x
        (f32.add
          (f32.add
            (local.get $x)
            (f32.const 352))
          (f32.convert_i32_s (i32.load8_u offset=1104 (local.get $kind)))))
